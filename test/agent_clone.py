"""
agent_clone.py - 초개인화 로컬 축제 & 쉼터 큐레이션 (Fest & Rest)
================================================================
...
- 프로그램이 '프로그램 정보 없음'인 경우 가상 행사를 지어내지 마세요.""")
        ...
        print(f"[agent_clone] LLM 기사 작성 중 예외 발생, 구조적 데이터 요약 안내문 반환: {e}")
...
if __name__ == "__main__":
    from data_clone import get_festival_infra_bundle

    print("=" * 70)
    print("🤖 Fest & Rest AI 오케스트레이터(agent_clone.py) [엄격한 통제 지침 3가지] 검증")
    print("=" * 70)
    ...
    print("\n▶ [테스트 1] data_clone.get_festival_infra_bundle() 호출...")
    ...
    print("\n" + "=" * 70)
    print("✅ agent_clone.py [엄격한 통제 지침 3가지] 100% 준수 검증 완료!")
    print("=" * 70)
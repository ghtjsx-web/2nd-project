...
- 🚨 [지리적 왜곡 및 포토스팟 할루시네이션 절대 금지]: 축제의 실제 개최 장소와 지형에 없는 가짜 배경(도심/내륙/공원 축제에 '오션뷰', '백사장', '파도', '모래조각', '해변', '바닷가' 등)을 절대 지어내지 마세요. 포토스팟은 오직 제공된 [인생샷 포토스팟] 및 축제장 실제 정보만을 근거로 서술해야 합니다.
